// Modified by MBrain: optional lossless MCP call result.
...
data class ToolResult(
    ...
    // MBrain: retain MCP content blocks, structuredContent and isError without re-encoding.
    val mcpResult: kotlinx.serialization.json.JsonObject? = null,
) {
    companion object {
