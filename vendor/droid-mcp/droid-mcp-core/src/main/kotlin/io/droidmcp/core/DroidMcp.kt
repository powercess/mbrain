// Modified by MBrain: configurable loopback-default HTTP host and listen validation.
...
class DroidMcp private constructor(
    ...
    /** MBrain: atomically refresh local and connected MCP tool catalogs. */
    fun replaceTools(tools: List<McpTool>) = registry.replaceAll(tools)
